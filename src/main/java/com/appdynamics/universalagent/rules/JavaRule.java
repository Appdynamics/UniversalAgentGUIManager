...
/**
 * Class Java Rule is the POJO class of a Java agent
 * 
 * @author nikolaos.papageorgiou
 *
 */
public class JavaRule extends Rule {
	...
	public JavaRule() {
		config = new JavaAgentConfig();
	}

	public JavaRule(String name, String comments, String monitor, JavaAgentConfig config, String condition) {
	...
	public JavaAgentConfig getConfig() {
		return config;
	}

	public void setConfig(JavaAgentConfig config) {
		this.config = config;
	}
